...
public class SmoothSphereBakedModel implements BakedModel {
    ...
    private enum SphereMaterial {
        ...
        GLOWING_CRYSTAL(42, 56, 138, 112, 170, 245, 230, 250, 255, 90, 14, 0.14F, 42.0F, 0.24F, 0.58F, 0.04F),
        ...
        BLUE_GLASS(22, 78, 156, 62, 166, 245, 212, 244, 255, 44, 0, 0.18F, 82.0F, 0.22F, 0.42F, 0.0F),
        CLEAR_GLASS(128, 170, 184, 198, 240, 255, 255, 255, 255, 26, 0, 0.16F, 90.0F, 0.18F, 0.36F, 0.0F),
        FROSTED_GLASS(135, 178, 184, 186, 228, 226, 232, 255, 248, 72, 0, 0.035F, 22.0F, 0.12F, 0.50F, 0.09F),
        LUMINOUS_GLASS(72, 180, 150, 150, 255, 220, 255, 255, 245, 58, 15, 0.12F, 34.0F, 0.22F, 0.44F, 0.025F),
